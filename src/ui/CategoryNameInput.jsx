function CategoryNameInput({ register, error }) {
  return (
    <div className="relative mt-5">
      <input
        ...
        type="text"
        id="name"
        className={` peer block w-full appearance-none rounded-md border border-gray-300 bg-gray-50 px-2.5 pb-2.5 pt-5 text-sm text-gray-900 focus:border-blue-600  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-blue-500`}
        placeholder=" "
      />
      <label
        htmlFor="name"
