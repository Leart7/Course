...
function Footer() {
  return (
    <>
      <div className="absolute bottom-0 left-0 right-0 flex flex-col gap-y-5 px-3 pb-5 md:flex-row md:flex-wrap md:items-center md:justify-center lg:items-start">
